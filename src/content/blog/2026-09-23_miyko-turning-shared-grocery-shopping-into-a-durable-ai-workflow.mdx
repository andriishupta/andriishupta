...
<ArticleScreenshotGallery screenshots={[
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/02-dual-user-empty-dashboard.png", alt: "Separate owner and viewer dashboards for the same shared order", width: 1800, height: 1922, caption: "Separate member sessions" },
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/03-household-members-and-provider.png", alt: "Group members, roles and Silpo provider connection", width: 1766, height: 1930, caption: "Group and provider settings" },
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/04-silpo-oauth-authorization.png", alt: "Silpo OAuth authorization screen for MiyKo", width: 892, height: 1910, caption: "Silpo authorization" },
]} />
...
<ArticleScreenshotGallery screenshots={[
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/06-owner-order-dashboard.png", alt: "Owner starting a dinner order in MiyKo", width: 884, height: 1914, caption: "Start the order" },
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/07-step-order-initial-plan.png", alt: "Initial shared dinner plan before provider actions", width: 880, height: 1908, caption: "Review the shared plan" },
  { src: "https://andriishupta.dev/images/blog/miyko-turning-shared-grocery-shopping-into-a-durable-ai-workflow/08-silpo-basket-ready.png", alt: "Real Silpo basket prepared after approval", width: 880, height: 1914, caption: "Prepare the real basket" },
]} />
